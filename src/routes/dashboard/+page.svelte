<script lang="ts">
    ...
    function handleScanComplete( event: CustomEvent<{ scanId: string }> ): void {
        ...
        <header class="mb-8 animate-slide-up">
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    <div class="w-12 h-12 rounded-2xl bg-linear-to-br from-emerald-400 to-teal-600 flex items-center justify-center glow-effect">
