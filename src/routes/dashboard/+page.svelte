            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-emerald-700/70 dark:text-emerald-400/70">Digital Footprint Optimizer</p>
                    </div>
                </div>
                ...
                <nav class="flex gap-2">
                    <button
                        onclick={() => goto('/scan')}
                        class="px-4 py-2 rounded-xl transition-all duration-300 glass-effect text-emerald-700 dark:text-emerald-400 hover:bg-slate-900/10 dark:hover:bg-white/10"
                    >
                        Scan
                    </button>
                </nav>
        ...
        <div class="animate-slide-up" style="animation-delay: 0.1s">
            <div class="space-y-6">
                ...
                <div class="glass-effect rounded-2xl p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-2xl font-bold text-emerald-700 dark:text-emerald-400">Recent Scans</h2>
                        <button
                            onclick={() => goto('/scan')}
                    ...
                    {:else if scans.length === 0}
                        <div class="text-center py-12">
                            ...
                            <p class="text-emerald-700/70 dark:text-emerald-400/70 mb-4">No scans yet. Start your first scan to optimize your digital footprint!</p>
                            <button
                                onclick={() => goto('/scan')}
                    ...
                    {:else}
                        <div class="space-y-3">
                            {#each scans as scan}
                                <div class="bg-slate-900/5 dark:bg-white/5 rounded-xl p-4 hover:bg-slate-900/10 dark:hover:bg-white/10 transition-all duration-300 border border-slate-900/10 dark:border-white/10">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h3 class="text-slate-900 dark:text-white font-semibold">{scan.source_type.charAt(0).toUpperCase() + scan.source_type.slice(1)} Scan</h3>
                                                    <p class="text-sm text-emerald-700/70 dark:text-emerald-400/70">{formatDate(scan.scan_date)}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="text-right space-y-1">
                                            ...
                                            <div class="text-sm text-emerald-700/70 dark:text-emerald-400/70">
